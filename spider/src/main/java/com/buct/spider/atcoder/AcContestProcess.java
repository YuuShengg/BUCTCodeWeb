...
public class AcContestProcess implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (title.equals("Contest Archive - AtCoder")) {
            Selectable table2 = page.getHtml().xpath("//*[@id=\"main-container\"]/div[1]/div[3]/div[2]/div/table");   // 过去的比赛
            ...
            for (i = 1; i <= tr2.size(); i++) {
                ...
                //    accontest.setAcContestId(tr2.size() - i + 1);
        ...
        if (title.equals("Present Contests - AtCoder")) {
            Selectable table1 = page.getHtml().xpath("//div[@id='contest-table-upcoming']/div/div/table");   // 未来的比赛
